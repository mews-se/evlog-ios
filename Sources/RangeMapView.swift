            ...
            VStack(alignment: .leading, spacing: 10) {
                HStack(spacing: 16) {
                    legend(color: .green, filled: true,
                           title: String(localized: "Realistic reach"), value: Fmt.distance(realistic, decimals: 0))
                    legend(color: .green.opacity(0.45), filled: false,
                           title: String(localized: "Straight line"), value: Fmt.distance(rangeKm, decimals: 0))
                }
                if !chargers.isEmpty {
